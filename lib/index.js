  ...
  _createClass(FirebaseFileUploader, [{
    ...
    value: function startUpload(file) {
      ...
      Promise.resolve().then(function () {
        var shouldResize = file.type.match(/image.*/) && (_this3.props.maxWidth || _this3.props.maxHeight);
        if (shouldResize) {
          return (0, _image2.default)(file, _this3.props.maxWidth, _this3.props.maxHeight);
        }
        return file;
      }).then(function (file) {
        ...
        task.on('state_changed', function (snapshot) {
          ...
          return onProgress && onProgress(Math.round(progress), task);
        }, function (error) {
